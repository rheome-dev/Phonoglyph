                  ...
                  {categoryEffects.map((effect, index) => {
                    ...
                    return (
                      ...
                      >
                        <Card
                          className={cn(
                            "h-36 cursor-pointer transition-all duration-500 ease-out border-4 relative overflow-hidden p-0",
                            "transform-gpu hover:scale-105 rounded-xl",
                            "group-hover:rotate-y-6 group-hover:rotate-x-2",
                            cardStyle.background,
                            cardStyle.border,
                            selectedEffects[effect.id]
                              ? `${cardStyle.glow} shadow-2xl ring-2 ring-white/30`
                              : "hover:shadow-xl"
                          )}
                          style={{ 
                          ...
                          <CardContent className="relative z-10 p-2 flex-1 flex flex-col">
                            ...
                            <div className="h-12 mb-1 rounded-lg bg-gradient-to-b from-slate-800 to-slate-900 border-2 border-slate-600 flex items-center justify-center relative overflow-hidden">
                              ...
                              <div className="text-center relative z-10">
                                <div className="text-sm drop-shadow-lg">
                                  {category === 'Generative' ? '🌊' : category === 'Overlays' ? '📊' : '✨'}
                                </div>
                            ...
                            {selectedEffects[effect.id] && (
                              <div className="absolute top-1 right-1 z-20">
                                <div className="bg-emerald-400 text-emerald-900 text-xs font-bold px-1 py-0.5 rounded border border-emerald-600 shadow-lg">
                                  ⚡
                                </div>
                              </div>
                            )}
