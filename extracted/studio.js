!function(e, t) {
    ...
    let h = class {
        constructor(e) {
            ...
            e && "Renderer" === e.type) {
                ...
                a(this.type + ": Renderer not passed as first argument", e);
            this.renderer = e,
            this.gl = e.gl,
            this.initStacks()
        }
        ...
        addToRenderTargetsStack(e) {
            ...
            if (e.target._depth) {
                ...
                s = t.findIndex(t => t.target.uuid === e.target.uuid);
            s = Math.max(0, s),
            t.splice(s, 0, e),
            e.target._depth ? (t.sort( (e, t) => e.index - t.index),
            t.sort( (e, t) => t.renderOrder - e.renderOrder)) : (t.sort( (e, t) => t.index - e.index),
        ...
        setPlaneRenderOrder(e) {
            if ("ShaderPass" === e.type)
                ...
                return;
            if (e.target)
                e.target._depth ? (this.stacks.renderTargets.sort( (e, t) => e.index - t.index),
                this.stacks.renderTargets.sort( (e, t) => t.renderOrder - e.renderOrder)) : (this.stacks.renderTargets.sort( (e, t) => t.index - e.index),
                ...
                !this.renderer.depth || s ? (t.sort( (e, t) => t.index - e.index),
                e._transparent && t.sort( (e, t) => e.relativeTranslation.z - t.relativeTranslation.z),
                t.sort( (e, t) => e.renderOrder - t.renderOrder)) : (t.sort( (e, t) => e.index - t.index),
    ...
    class u {
        constructor({alpha: e, antialias: t, premultipliedAlpha: s, depth: i, failIfMajorPerformanceCaveat: a, preserveDrawingBuffer: n, stencil: o, container: h, pixelRatio: l, renderingScale: d, production: u, onError: c, onSuccess: p, onContextLost: m, onContextRestored: g, onDisposed: f, onSceneChange: _}) {
            this.type = "Renderer",
            this.alpha = e,
            this.antialias = t,
            ...
            !this.gl)
                return this.production || r(this.type + ": WebGL context could not be created"),
        ...
        restoreContext() {
            ...
            this.gl && this.extensions.WEBGL_lose_context ? this.extensions.WEBGL_lose_context.restoreContext() : (this.gl || this.production ? this.extensions.WEBGL_lose_context || this.production || r(this.type + ": Could not restore the context because the restore context extension is not defined") : r(this.type + ": Could not restore the context because the context is not defined"),
    ...
    class p {
        constructor({container: e, alpha: t=!0, premultipliedAlpha: s=!1, antialias: i=!0, depth: a=!0, failIfMajorPerformanceCaveat: n=!0, preserveDrawingBuffer: o=!1, stencil: h=!1, autoResize: l=!0, autoRender: d=!0, watchScroll: u=!0, pixelRatio: c=window.devicePixelRatio || 1, renderingScale: p=1, production: m=!1}={}) {
            this.type = "Curtains",
            this._autoResize = l,
            this._autoRender = d,
            this._watchScroll = u,
            ...
            this._renderingScale = Math.max(.25, Math.min(1, p)),
            this.premultipliedAlpha = s,
            this.alpha = t,
            this.antialias = i,
            this.depth = a,
        ...
        setUniforms() {
            if (this.uniforms)
                for (const e in this.uniforms) {
                    ...
                    this.renderer.production || r(this.type + ": No uniform type declared for " + t.name + ", applied a 4f (array of 4 floats) uniform type")) : 3 === t.value.length ? (t.type = "3f",
                    this.renderer.production || r(this.type + ": No uniform type declared for " + t.name + ", applied a 3f (array of 3 floats) uniform type")) : 2 === t.value.length && (t.type = "2f",
                    this.renderer.production || r(this.type + ": No uniform type declared for " + t.name + ", applied a 2f (array of 2 floats) uniform type")) : "mat" === t._internalFormat ? 16 === t.value.length ? (t.type = "mat4",
                    this.renderer.production || r(this.type + ": No uniform type declared for " + t.name + ", applied a mat4 (4x4 matrix array) uniform type")) : 9 === t.value.length ? (t.type = "mat3",
                    this.renderer.production || r(this.type + ": No uniform type declared for " + t.name + ", applied a mat3 (3x3 matrix array) uniform type")) : 4 === t.value.length && (t.type = "mat2",
        ...
        updateUniforms() {
            if (this.uniforms)
                for (const e in this.uniforms) {
                    ...
                    let s = !1;
                    "Vec2" === t._internalFormat || "Vec3" === t._internalFormat || "Quat" === t._internalFormat ? t.value.equals(t.lastValue) || (s = !0,
    ...
    class w {
        constructor(e, {parent: t, vertexShader: s, fragmentShader: i}={}) {
            ...
            s ? this.vsCode = s : (this.renderer.production || "Plane" !== this.parent.type || r(this.parent.type + ": No vertex shader provided, will use a default one"),
            this.vsCode = this.defaultVsCode),
            i ? this.fsCode = i : (this.renderer.production || r(this.parent.type + ": No fragment shader provided, will use a default one"),
        ...
        createProgram() {
            ...
            !this.renderer.production && !this.gl.getProgramParameter(this.program, this.gl.LINK_STATUS))
                return r(this.type + ": Unable to initialize the shader program: " + this.gl.getProgramInfoLog(this.program)),
        ...
        computeVerticesUVs() {
            ...
            for (let s = 0; s < this.definition.height; s++) {
                ...
                for (let s = 0; s < this.definition.width; s++) {
                    ...
                    t.push(i),
                    t.push(0),
                    e.push(2 * (r + 1 / this.definition.width - .5)),
                    e.push(2 * (i - .5)),
                    e.push(0),
                    t.push(r),
                    ...
                    t.push(0),
                    e.push(2 * (r - .5)),
                    e.push(2 * (i + 1 / this.definition.height - .5)),
                    e.push(0),
                    t.push(r),
                    t.push(i + 1 / this.definition.height),
                    t.push(0),
    ...
    class R {
        ...
        composeFromOrigin(e, t, s, i) {
            ...
            r[10] = O,
            r[11] = 0,
            r[12] = e.x + T - (M * T + k * R + I * S),
            r[13] = e.y + R - (E * T + A * R + D * S),
            r[14] = e.z + S - (C * T + F * R + O * S),
            r[15] = 1,
            this
        }
    }
    ...
    class M {
        ...
        applyQuat(e) {
            const t = this._x
              ...
              , d = o * i + r * s - a * t
              , u = -r * t - a * s - n * i;
            return this._x = h * o + u * -r + l * -n - d * -a,
    ...
    const E = new S
      ...
      , k = new R;
    class A {
        constructor(e, {isFBOTexture: t=!1, fromTexture: s=!1, loader: i, sampler: r, floatingPoint: o="none", premultiplyAlpha: h=!1, anisotropy: l=1, generateMipmap: d=null, wrapS: u, wrapT: c, minFilter: p, magFilter: m}={}) {
            if (this.type = "Texture",
            (e = e && e.renderer || e) && "Renderer" === e.type) {
                if (!e.gl)
                    return void (e.production || a(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"))
            } else
                a(this.type + ": Renderer not passed as first argument", e);
            if (this.renderer = e,
            this.gl = this.renderer.gl,
        ...
        addParent(e) {
            !e || "Plane" !== e.type && "PingPongPlane" !== e.type && "ShaderPass" !== e.type && "RenderTarget" !== e.type ? this.renderer.production || r(this.type + ": cannot add texture as a child of ", e, " because it is not a valid parent") : (this._parent = e,
        ...
        copy(e) {
            ...
            this._canDraw = !0),
            this._updateTexParameters(),
            this.renderer.needRender()) : this.renderer.production || r(this.type + ": Unable to set the texture from texture:", e)
        }
        setSource(e) {
            ...
            if ("video" !== t && "canvas" !== t || (this._useCache = !1),
            this._useCache) {
        ...
        _updateTexParameters() {
            ...
            this.parameters.wrapS !== this._state.wrapS && (this.renderer._isWebGL2 || o(this._size.width) && o(this._size.height) || (this.parameters.wrapS = this.gl.CLAMP_TO_EDGE),
            ...
            this.parameters.wrapT !== this._state.wrapT && (this.renderer._isWebGL2 || o(this._size.width) && o(this._size.height) || (this.parameters.wrapT = this.gl.CLAMP_TO_EDGE),
            ...
            this.parameters.generateMipmap && !this._state.generateMipmap && this.source && (this.renderer._isWebGL2 || o(this._size.width) && o(this._size.height) ? this.gl.generateMipmap(this.gl.TEXTURE_2D) : this.parameters.generateMipmap = !1,
            this._state.generateMipmap = this.parameters.generateMipmap),
            this.parameters.minFilter !== this._state.minFilter && (this.renderer._isWebGL2 || o(this._size.width) && o(this._size.height) || (this.parameters.minFilter = this.gl.LINEAR),
            ...
            this.parameters.magFilter !== this._state.magFilter && (this.renderer._isWebGL2 || o(this._size.width) && o(this._size.height) || (this.parameters.magFilter = this.gl.LINEAR),
        ...
        _getSizes() {
            ...
            const e = this._parent.scale ? E.set(this._parent.scale.x, this._parent.scale.y) : E.set(1, 1)
            ...
            let o = 0
              , h = 0;
            return n > a ? h = Math.min(0, s - t * (1 / a)) : n < a && (o = Math.min(0, t - s * a)),
            {
                parentWidth: t,
                parentHeight: s,
                sourceWidth: i,
        ...
        setScale(e) {
            e.type && "Vec2" === e.type ? (e.sanitizeNaNValuesWith(this.scale).max(E.set(.001, .001)),
            e.equals(this.scale) || (this.scale.copy(e),
            this.resize())) : this.renderer.production || r(this.type + ": Cannot set scale because the parameter passed is not of Vec2 type:", e)
        }
        setOffset(e) {
            e.type && "Vec2" === e.type ? (e.sanitizeNaNValuesWith(this.offset),
            e.equals(this.offset) || (this.offset.copy(e),
            this.resize())) : this.renderer.production || r(this.type + ": Cannot set offset because the parameter passed is not of Vec2 type:", scale)
        }
        _setSize() {
        ...
        _updateTextureMatrix(e) {
            ...
            t.x /= this.scale.x,
            t.y /= this.scale.y,
            this._textureMatrix.matrix = k.setFromArray([t.x, 0, 0, 0, 0, t.y, 0, 0, 0, 0, 1, 0, (1 - t.x) / 2 + this.offset.x, (1 - t.y) / 2 + this.offset.y, 0, 1]),
        ...
        _dispose(e=!1) {
            ...
            this.source = null) : "canvas" === this.sourceType && this.source && (this.source.width = null == (t = this.source) ? void 0 : t.width,
            this.source = null),
            this._parent = null;
    ...
    class F {
        ...
        loadImage(e, t={}, s, i) {
            ...
            r) {
                ...
                a.fromTexture = r;
                const t = new A(this.renderer,a);
                return this._sourceLoaded(r.source, t, s),
        ...
        loadVideo(e, t={}, s, i) {
            ...
            "requestVideoFrameCallback"in HTMLVideoElement.prototype && (o.videoFrameCallback = n._videoFrameCallback.bind(n),
    ...
    class I extends F {
        constructor(e, t, {sourcesLoaded: s=0, sourcesToLoad: i=0, complete: a=!1, onComplete: n= () => {}
            ...
            this._parent = t,
            "Plane" !== this._parent.type && "PingPongPlane" !== this._parent.type && "ShaderPass" !== this._parent.type && (r(this.type + ": Wrong parent type assigned to this loader"),
            this._parent = null),
    ...
    class D {
        constructor(e, t="Mesh", {vertexShaderID: s, fragmentShaderID: i, vertexShader: r, fragmentShader: n, uniforms: o={}, widthSegments: h=1, heightSegments: l=1, renderOrder: d=0, depthTest: u=!0, cullFace: c="back", texturesOptions: p={}, crossOrigin: m="anonymous"}={}) {
            if (this.type = t,
            (e = e && e.renderer || e) && "Renderer" === e.type || (a(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e),
            setTimeout( () => {
            ...
            this.gl = this.renderer.gl,
            !this.gl)
                return this.renderer.production || a(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"),
                void setTimeout( () => {
                    this._onErrorCallback && this._onErrorCallback()
                }
                , 0);
            ...
            h = parseInt(h),
            l = parseInt(l),
            this._geometry = new T(this.renderer,{
                width: h,
                height: l
            }),
            this._program = new w(this.renderer,{
                parent: this,
                vertexShader: r,
                fragmentShader: n
            }),
        ...
        _initMesh() {
            this.uuid = n(),
            this.loader = new I(this.renderer,this,{
                sourcesLoaded: 0,
                initSourcesToLoad: 0,
                complete: !1,
                onComplete: () => {
        ...
        setRenderTarget(e) {
            ...
            this.target = e,
            "Plane" === this.type && this.renderer.scene.addPlane(this)) : this.renderer.production || r(this.type + ": Could not set the render target because the argument passed is not a RenderTarget class object", e)
        }
        setRenderOrder(e=0) {
        ...
        createTexture(e={}) {
            const t = new A(this.renderer,Object.assign(e, this._texturesOptions));
            return t.addParent(this),
            t
        }
        addTexture(e) {
            e && "Texture" === e.type ? e.addParent(this) : this.renderer.production || r(this.type + ": cannot add ", e, " to this " + this.type + " because it is not a valid texture")
        }
        loadSources(e, t={}, s, i) {
            for (let r = 0; r < e.length; r++)
                this.loadSource(e[r], t, s, i)
        ...
        loadSource(e, t={}, s, i) {
            this.loader.loadSource(e, Object.assign(t, this._texturesOptions), e => {
                s && s(e)
            }
            , (e, t) => {
                this.renderer.production || r(this.type + ": this HTML tag could not be converted into a texture:", e.tagName),
                i && i(e, t)
            }
            )
        }
        loadImage(e, t={}, s, i) {
            this.loader.loadImage(e, Object.assign(t, this._texturesOptions), e => {
                s && s(e)
            }
            , (e, t) => {
        ...
        loadVideo(e, t={}, s, i) {
            this.loader.loadVideo(e, Object.assign(t, this._texturesOptions), e => {
                s && s(e)
            }
            , (e, t) => {
    ...
    const O = new S
      , z = new S;
    class L extends D {
        constructor(e, t, s="DOMMesh", {widthSegments: i, heightSegments: a, renderOrder: n, depthTest: o, cullFace: h, uniforms: l, vertexShaderID: d, fragmentShaderID: u, vertexShader: c, fragmentShader: p, texturesOptions: m, crossOrigin: g}={}) {
            super(e, s, {
                widthSegments: i,
                heightSegments: a,
                renderOrder: n,
            ...
            this.htmlElement && 0 !== this.htmlElement.length || this.renderer.production || r(this.type + ": The HTML element you specified does not currently exists in the DOM"),
        ...
        mouseToPlaneCoords(e) {
            const t = this.scale ? this.scale : z.set(1, 1)
              , s = O.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2)
    ...
    class V {
        ...
        setFromVec3(e) {
            const t = .5 * e.x
              ...
              , h = Math.sin(s)
              , l = Math.sin(i);
            return "XYZ" === this.axisOrder ? (this.elements[0] = o * a * n + r * h * l,
            this.elements[1] = r * h * n - o * a * l,
            this.elements[2] = r * a * l + o * h * n,
            this.elements[3] = r * a * n - o * h * l) : "YXZ" === this.axisOrder ? (this.elements[0] = o * a * n + r * h * l,
            this.elements[1] = r * h * n - o * a * l,
            this.elements[2] = r * a * l - o * h * n,
            this.elements[3] = r * a * n + o * h * l) : "ZXY" === this.axisOrder ? (this.elements[0] = o * a * n - r * h * l,
            this.elements[1] = r * h * n + o * a * l,
            this.elements[2] = r * a * l + o * h * n,
            this.elements[3] = r * a * n - o * h * l) : "ZYX" === this.axisOrder ? (this.elements[0] = o * a * n - r * h * l,
            this.elements[1] = r * h * n + o * a * l,
            this.elements[2] = r * a * l - o * h * n,
            this.elements[3] = r * a * n + o * h * l) : "YZX" === this.axisOrder ? (this.elements[0] = o * a * n + r * h * l,
            this.elements[1] = r * h * n + o * a * l,
            this.elements[2] = r * a * l - o * h * n,
            this.elements[3] = r * a * n - o * h * l) : "XZY" === this.axisOrder && (this.elements[0] = o * a * n - r * h * l,
            this.elements[1] = r * h * n - o * a * l,
            this.elements[2] = r * a * l + o * h * n,
    ...
    const B = new S
      ...
      , te = new S;
    class se extends L {
        constructor(e, t, {widthSegments: s, heightSegments: i, renderOrder: r, depthTest: a, cullFace: n, uniforms: o, vertexShaderID: h, fragmentShaderID: l, vertexShader: d, fragmentShader: u, texturesOptions: c, crossOrigin: p, alwaysDraw: m=!1, visible: g=!0, transparent: f=!1, drawCheckMargins: _={
            top: 0,
            right: 0,
            bottom: 0,
            left: 0
        }, autoloadSources: x=!0, watchScroll: v=!0, fov: y=50}={}) {
            super(e, t, "Plane", {
                widthSegments: s,
                heightSegments: i,
                renderOrder: r,
        ...
        _initTransformValues() {
            ...
            this.transformOrigin = new M(.5,.5,0),
        ...
        resetPlane(e) {
            ...
            this.resize()) : e || this.renderer.production || r(this.type + ": You are trying to reset a plane with a HTML element that does not exist. The old HTML element will be kept instead.")
        }
        removeRenderTarget() {
        ...
        _setWorldTransformOrigin() {
            this._boundingRect.world.transformOrigin = new M((2 * this.transformOrigin.x - 1) * this._boundingRect.world.width,-(2 * this.transformOrigin.y - 1) * this._boundingRect.world.height,this.transformOrigin.z)
        }
        ...
        setScale(e) {
            e.type && "Vec2" === e.type ? (e.sanitizeNaNValuesWith(this.scale).max(B.set(.001, .001)),
            e.x === this.scale.x && e.y === this.scale.y || (this.scale.set(e.x, e.y, 1),
            this._applyScale())) : this.renderer.production || r(this.type + ": Cannot set scale because the parameter passed is not of Vec2 type:", e)
        }
        _applyScale() {
            for (let e = 0; e < this.textures.length; e++)
                this.textures[e].resize();
        ...
        setRotation(e) {
            ...
            this._applyRotation())) : this.renderer.production || r(this.type + ": Cannot set rotation because the parameter passed is not of Vec3 type:", e)
        }
        _applyRotation() {
        ...
        setTransformOrigin(e) {
            ...
            this._setWorldTransformOrigin(),
            this._updateMVMatrix = !0)) : this.renderer.production || r(this.type + ": Cannot set transform origin because the parameter passed is not of Vec3 type:", e)
        }
        _setTranslation() {
            let e = W.set(0, 0, 0);
        ...
        setRelativeTranslation(e) {
            ...
            this._setTranslation())) : this.renderer.production || r(this.type + ": Cannot set translation because the parameter passed is not of Vec3 type:", e)
        }
        ...
        _getNearPlaneIntersections(e, t, s) {
            ...
            if (1 === s.length)
                0 === s[0] ? (t[0] = this._getIntersection(t[1], Y.set(.95, 1, 0).applyMat4(i)),
                t.push(this._getIntersection(t[3], q.set(-1, -.95, 0).applyMat4(i)))) : 1 === s[0] ? (t[1] = this._getIntersection(t[0], Y.set(-.95, 1, 0).applyMat4(i)),
                t.push(this._getIntersection(t[2], q.set(1, -.95, 0).applyMat4(i)))) : 2 === s[0] ? (t[2] = this._getIntersection(t[3], Y.set(-.95, -1, 0).applyMat4(i)),
                t.push(this._getIntersection(t[1], q.set(1, .95, 0).applyMat4(i)))) : 3 === s[0] && (t[3] = this._getIntersection(t[2], Y.set(.95, -1, 0).applyMat4(i)),
                t.push(this._getIntersection(t[0], q.set(-1, .95, 0).applyMat4(i))));
            else if (2 === s.length)
                0 === s[0] && 1 === s[1] ? (t[0] = this._getIntersection(t[3], Y.set(-1, -.95, 0).applyMat4(i)),
                t[1] = this._getIntersection(t[2], q.set(1, -.95, 0).applyMat4(i))) : 1 === s[0] && 2 === s[1] ? (t[1] = this._getIntersection(t[0], Y.set(-.95, 1, 0).applyMat4(i)),
                t[2] = this._getIntersection(t[3], q.set(-.95, -1, 0).applyMat4(i))) : 2 === s[0] && 3 === s[1] ? (t[2] = this._getIntersection(t[1], Y.set(1, .95, 0).applyMat4(i)),
                t[3] = this._getIntersection(t[0], q.set(-1, .95, 0).applyMat4(i))) : 0 === s[0] && 3 === s[1] && (t[0] = this._getIntersection(t[1], Y.set(.95, 1, 0).applyMat4(i)),
                t[3] = this._getIntersection(t[2], q.set(.95, -1, 0).applyMat4(i)));
            else if (3 === s.length) {
                let r = 0;
                for (let t = 0; t < e.length; t++)
                    s.includes(t) || (r = t);
                t = [t[r]],
                0 === r ? (t.push(this._getIntersection(t[0], Y.set(-.95, 1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(-1, .95, 0).applyMat4(i)))) : 1 === r ? (t.push(this._getIntersection(t[0], Y.set(.95, 1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(1, .95, 0).applyMat4(i)))) : 2 === r ? (t.push(this._getIntersection(t[0], Y.set(.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(1, -.95, 0).applyMat4(i)))) : 3 === r && (t.push(this._getIntersection(t[0], Y.set(-.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(-1.95, 0).applyMat4(i))))
            } else
                for (let r = 0; r < e.length; r++)
                    t[r][0] = 1e4,
        ...
        _getWorldCoords() {
            const e = [H.set(-1, 1, 0), j.set(1, 1, 0), G.set(1, -1, 0), X.set(-1, -1, 0)];
            let t = []
              , s = [];
            for (let o = 0; o < e.length; o++) {
                const i = e[o].applyMat4(this._matrices.modelViewProjection.matrix);
                t.push(i),
                Math.abs(i.z) > 1 && s.push(o)
            }
        ...
        mouseToPlaneCoords(e) {
            if ($.setAxisOrder(this.quaternion.axisOrder),
                ...
                return super.mouseToPlaneCoords(e);
            {
                ...
                if (Math.abs(n) >= 1e-4) {
                    ...
                    a.copy(s.add(i.multiplyScalar(h))),
                    a.applyMat4(e)
                } else
                    a.set(1 / 0, 1 / 0, 1 / 0);
    ...
    class ie {
        constructor(e, {shaderPass: t, depth: s=!1, clear: i=!0, maxWidth: r, maxHeight: o, minWidth: h=1024, minHeight: l=1024, texturesOptions: d={}}={}) {
        ...
        _createFrameBuffer() {
            ...
            this.textures.length)
                ...
                new A(this.renderer,this._texturesOptions).addParent(this)
            }
        ...
        remove() {
            this._shaderPass ? this.renderer.production || r(this.type + ": You're trying to remove a RenderTarget attached to a ShaderPass. You should remove that ShaderPass instead:", this._shaderPass) : (this._dispose(),
    ...
    let ae, ne, oe, he, le = !1, de = window.innerHeight || document.documentElement.clientHeight, ue = window.innerWidth || document.documentElement.clientWidth, ce = window.scrollY || window.pageYOffset, pe = 0, me = 0, ge = 0;
    const fe = .001;
    function _e(e) {
    ...
    function ve(e, t, s, i, r) {
        if (s.length > 1) {
            let a, n = i ? 2 * +i * Math.PI : 0, o = t.width / 2, h = t.height / 2, l = t.width / 2, d = t.height / 2;
            if ("radial" === r) {
                const t = Math.max(l, d);
                a = e.createRadialGradient(o, h, t, o, h, 0)
            }
            const u = Math.cos(n) * l
              , c = Math.sin(n) * d;
            if ("linear" === r && (a = e.createLinearGradient(o - u, h - c, o + u, h + c)),
            "conic" === r) {
                a = e.createConicGradient(-Math.PI + n, o, h);
                const t = [...s, ...s.slice().reverse()];
                t.forEach( (e, s) => {
                    a.addColorStop(s * (1 / (t.length - 1)), e)
                }
                )
            } else
                s.forEach( (e, t) => {
                    a.addColorStop(t * (1 / (s.length - 1)), e)
                }
                );
            return a
        }
    ...
    function ye(e) {
        ...
        if (t[e])
            return t[e];
        if ("string" == typeof e && (e.includes("=>") || e.includes("function") || e.includes("x"))) {
    ...
    function Re(e) {
        if (void 0 !== e.local.isDynamicCache)
            return e.local.isDynamicCache;
        const t = ["trackMouse", "axisTilt", "trackMouseMove", "rotationTracking", "lightTracking"].some(t => e.hasOwnProperty(t) && 0 !== e[t])
          , s = e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover].length > 0
          , i = ("effect" === e.layerType || e.isModel) && (e.animating || e.usesPingPong)
          , r = "video" === e.type
          , a = t || s || i || r;
        return e.local.isDynamicCache = a,
        a
    }
    function Se(e, t) {
        if (e.noTextAsHtml)
    ...
    function Me() {
        Qe.filter(e => !document.body.contains(e.element)).forEach(e => {
    ...
    function Ee() {
        ...
        let e = Qe.filter(e => !e.destroyed && e.getDynamicLayers().length > 0);
        const t = s => {
            let i = !1;
            e.forEach(e => {
                e.destroyed || (e.isInView && e.initialized ? (e.rendering = !0,
                s - (e.lastTime || 0) >= e.frameDuration && !e.paused && (e.renderFrame(),
                e.lastTime = s),
                i = !0) : e.rendering = !1)
            }
            ),
            (!ge || s - ge > 64) && (ce = window.scrollY || window.pageYOffset,
            me = ce - pe,
            pe = ce,
            ge = s,
            (me > 1e3 || me < 0 && !pe && !ce) && Ye()),
            i ? (!function() {
                let e = performance.now();
                Qe.forEach(t => {
                    var s, i, r, a, n, o;
                    if (t.isInView && (null == (i = null == (s = t.curtain) ? void 0 : s.planes) ? void 0 : i.find(e => e.uniforms.mousePos)))
                        if (we() && (null == (a = null == (r = t.interactivity) ? void 0 : r.mouse) ? void 0 : a.disableMobile) || (null == (o = null == (n = t.interactivity) ? void 0 : n.mouse) ? void 0 : o.disabled))
                            ;
                        else {
                            ...
                            let s = t.isFixed ? t.bbox.top : t.bbox.top + t.scrollY
                              , i = t.bbox.left;
                            t.mouse.page.x > i && t.mouse.page.y > s && t.mouse.page.x < t.lastBbox.width + i && t.mouse.page.y < t.lastBbox.height + s ? t.mouse.enterTime || (t.mouse.enterTime = e) : t.mouse.enterTime = null
                        }
                }
                )
            }(),
            oe = requestAnimationFrame(t)) : cancelAnimationFrame(oe)
        }
        ;
    ...
    function ke(e, t) {
        return "Vec2" === e.type ? e = new S(e._x,e._y) : "Vec3" === e.type && (e = new M(e._x,e._y,e._z)),
        e
    }
    function Ae(e, t, s) {
        (null == e ? void 0 : e.type) && ("Vec2" === (null == e ? void 0 : e.type) || "Vec3" === (null == e ? void 0 : e.type)) ? (t.value.x = e.x,
        t.value.y = "pos" === s ? 1 - e.y : e.y,
        "Vec3" === e.type && (t.value.z = e.z)) : t.value = e
    }
    function Fe(e, t, s) {
        e.createTexture({
            sampler: t,
    ...
    void 0 !== document.hidden ? (ae = "hidden",
    ne = "visibilitychange") : void 0 !== document.msHidden ? (ae = "msHidden",
    ne = "msvisibilitychange") : void 0 !== document.webkitHidden && (ae = "webkitHidden",
    ne = "webkitvisibilitychange");
    class Ie {
        constructor({prop: e, value: t, endValue: i, transition: r, breakpoints: a, uniformData: n, loop: o="none", loopDelay: h=0}) {
            ...
            this.uniformData = n,
            this.value = ke(t),
            this.endValue = void 0 !== i ? ke(i || 0) : null,
            ...
            this.loop = o,
            this.loopDelay = h,
            this.easeFunction = ye(this.transition.ease)
        }
        updateEffect(e, t) {
            if (void 0 === (e = this.endValue ?? e))
                return !1;
            ...
            if ("none" !== this.loop) {
                const t = this.transition.duration + this.loopDelay
                  , r = i % t;
                if (r > this.transition.duration)
                    return !1;
                const a = r / this.transition.duration
                  , n = Math.floor(i / t);
                let o = a;
                return "reverse" === this.loop && n % 2 == 1 && (o = 1 - a),
                this.progress = this.easeFunction(o),
                this.lastTick = s,
                Ce(this.value, e, this.progress)
            }
            const r = Math.max(0, Math.min(1, i / this.transition.duration));
            return this.progress = this.easeFunction(r),
            0 !== this.progress && (r >= 1 ? (this.complete = !0,
            this.progress = 0,
            e) : (this.lastTick = s,
            !this.complete && Ce(this.value, e, this.progress)))
        }
        resetState() {
            this.progress = 0,
            this.complete = !1,
    ...
    class De {
        constructor({prop: e, value: t, range: i, offset: r, momentum: a, uniformData: n, mode: o="scrollIntoView", delta: h=.01, absScrollValue: l=!0, breakpoints: d=[]}) {
            s(this, "id", xe()),
            this.prop = e,
            this.progress = 0,
            this.momentum = a,
        ...
        updateEffect(e, {top: t, height: s, isFixed: i}) {
            if (void 0 === e)
                return !1;
            if (i && (t -= ce),
            "scrollIntoView" === this.mode) {
                const i = t + ce - de * this.offset
                  , r = i + (de + s) * this.range;
                let a = (ce - i) / (r - i)
                  , n = Math.max(0, Math.min(1, a));
                return !(void 0 !== this.lastTick && (n = Pe(n, this.lastTick, 2 * this.momentum),
                Math.abs(this.lastTick - n) < fe)) && (this.lastTick = n,
                Ce(e, this.value, n))
            }
            if ("whileScrolling" === this.mode) {
                let t = me * this.delta;
                return this.absScrollValue && (t = Math.abs(t)),
                void 0 !== this.lastTick && (t = Pe(t, this.lastTick, 2 * this.momentum),
                Math.abs(t) < fe) ? !1 : (this.lastScrollPos = ce,
                this.lastTick = t,
                Ce(e, this.value, t))
            }
            return !1
    ...
    class Oe {
        ...
        updateEffect(e, t, s) {
            ...
            const r = null == (i = null == s ? void 0 : s.getParent) ? void 0 : i.call(s)
              , a = performance.now();
            if (this.triggerOnElement && ((null == s ? void 0 : s.isElement) || r)) {
                let e = (r || s).isHovered();
            ...
            n ? this.rawProgress = Math.max(0, this.rawProgress - h) : (this.lastEnterTime !== t && (this.lastProgress = this.rawProgress || 0),
            this.rawProgress = Math.min(1, this.lastProgress + h));
            const l = this.easeFunction(this.rawProgress)
              , d = Math.abs(this.progress - l) > fe;
            return this.progress = l,
            !(!t && !d) && (!t && this.transition.forwardsOnly && (this.progress = 0,
            this.rawProgress = 0),
            this.lastTick = a,
            this.lastEnterTime = t,
            !!d && Ce(e, this.value, this.progress))
        }
        resetState() {
            this.progress = 0
        }
    ...
    class ze {
        constructor(e, t, i) {
            ...
            this.breakpoints = ((r = e.breakpoints || []).forEach(e => {
                var t, s;
                for (let i in e.props)
                    "Vec2" === (null == (t = e.props[i]) ? void 0 : t.type) ? e.props[i] = new S(e.props[i]._x,e.props[i]._y) : "Vec3" === (null == (s = e.props[i]) ? void 0 : s.type) ? e.props[i] = new M(e.props[i]._x,e.props[i]._y,e.props[i]._z) : "object" == typeof e.props[i] && (e.props[i] = be(e.props[i]))
            }
            ),
            r),
            ...
            this.states = {
                appear: e.states && e.states.appear ? e.states.appear.map(e => new Ie(e)) : [],
                scroll: e.states && e.states.scroll ? e.states.scroll.map(e => new De(e)) : [],
                hover: e.states && e.states.hover ? e.states.hover.map(e => new Oe(e)) : []
            }
        }
        state() {
            return Qe.find(e => e.id === this.local.sceneId) || this.initOptions
        }
        getIndex() {
        ...
        getPlane() {
            var e, t, s;
            return null == (s = null == (t = null == (e = this.state()) ? void 0 : e.curtain) ? void 0 : t.planes) ? void 0 : s.find(e => "PingPongPlane" !== e.type && e.userData.id === this.local.id)
        }
        getPlanes() {
            var e, t, s;
            return (null == (s = null == (t = null == (e = this.state()) ? void 0 : e.curtain) ? void 0 : t.planes) ? void 0 : s.filter(e => "PingPongPlane" !== e.type && e.userData.id === this.local.id)) || []
        }
        getMaskedItem() {
        ...
        setBreakpointValues() {
            const e = ue
              ...
              , s = {};
            if (1 === t.length && "Desktop" === t[0].name)
                return;
            ...
            for (let r = t.length - 1; r >= 0; r--) {
                ...
                if (null === i.max || e <= i.max)
                    for (let e in i.props)
                        s.hasOwnProperty(e) || (s[e] = i.props[e])
            }
            const i = this.breakpoints.find(e => "Desktop" === e.name);
            if (i)
                for (let r in i.props)
                    s.hasOwnProperty(r) || (s[r] = i.props[r]);
            for (let r in s)
                if (this.hasOwnProperty(r)) {
                    let e = s[r];
                    (null == e ? void 0 : e.type) ? (this[r].x = e._x,
                    this[r].y = e._y,
                    void 0 !== e._z && (this[r].z = e._z)) : this[r] = e
                }
            this.local.bpProps = s
        }
        updateStateEffects() {
            var e, t, s, i;
            if (!this.states.appear.some(e => !e.complete) && !(null == (e = this.states) ? void 0 : e.scroll.length) && !(null == (t = this.states) ? void 0 : t.hover.length) || this.isModel && !this.local.modelLoaded)
                return;
            ...
            this.local.cachedBreakpoint && this.local.cachedBreakpoint === (null == (s = r.currentBreakpoint) ? void 0 : s.name) || (this.local.cachedBreakpoint = null == (i = r.currentBreakpoint) ? void 0 : i.name);
            const n = e => !e.breakpoints || 0 === e.breakpoints.length || e.breakpoints.find(e => e === this.local.cachedBreakpoint);
            r.isInView && (null === this.local.createdAt && (this.local.createdAt = a),
            this.states.appear.forEach(e => {
                if (!n(e))
                    return;
                let t = e.startTime || this.local.createdAt;
                if (!e.initialized) {
                    const s = [...this.states.appear.filter(t => t.prop === e.prop)].sort( (e, t) => (e.transition.delay || 0) - (t.transition.delay || 0))[0];
                    (null == s ? void 0 : s.id) === e.id && (this.local.uniformUpdatesPool[e.prop] = e.value,
                ...
                !1 !== s && (this.local.uniformUpdatesPool[e.prop] = s,
                this.local.hasUpdates = !0,
                this.local.updatedProps.add(e.prop)),
                this.isElement && e.complete && this.local.stateEffectProps && this.local.stateEffectProps[e.prop] && delete this.local.stateEffectProps[e.prop]
            }
            )),
            this.states.hover.forEach(e => {
                if (!n(e))
                    return;
                const t = e.updateEffect(this[e.prop], r.mouse.enterTime, this);
                !1 !== t && (this.local.uniformUpdatesPool[e.prop] = t,
                this.local.hasUpdates = !0,
                this.local.updatedProps.add(e.prop))
            }
            ),
            this.states.scroll.forEach(e => {
                ...
                !1 !== i && (this.local.uniformUpdatesPool[e.prop] = i,
                this.local.hasUpdates = !0,
                this.local.updatedProps.add(e.prop))
            }
            ),
            this.local.hasUpdates && (this.getPlanes().forEach(e => {
                ...
                for (let s of this.local.updatedProps) {
                    ...
                    void 0 !== i && ((null == (t = e.uniforms[s]) ? void 0 : t.lastValue) !== i && (e.uniforms[s] && Ae(i, e.uniforms[s], s),
    ...
    function Le(e) {
        ...
        return t[e] || t.topLeft
    }
    let Ue = class extends ze {
        constructor(e, t) {
            super(e, t),
            s(this, "isElement", !0),
            this.anchorPoint = e.anchorPoint || "topLeft",
            ...
            this.maskBackground = e.maskBackground || {},
            this.mask = e.mask || 0,
        ...
        unpackage() {
            return this.effects = be(this.effects),
            this.maskBackground = new M(this.maskBackground._x,this.maskBackground._y,this.maskBackground._z),
            this.unpackageType(),
            this
        }
        createLocalCanvas() {
            ...
            t.width = e.canvasWidth * s,
            t.height = e.canvasHeight * s;
        ...
        resize() {
            ...
            (null == (t = null == (e = this.states) ? void 0 : e.appear) ? void 0 : t.some(e => !e.complete)) || this.render(),
            "text" === this.layerType && Se(this, this.state().element)
        }
        dispose() {
            this.local.canvas && (this.local.canvas.width = 1,
        ...
        getAbsoluteDimensions() {
            ...
            return "auto" !== this.widthMode && (a = "fixed" === this.widthMode ? l : l * o,
            "auto" === this.heightMode && (n = a / (this.aspectRatio || 1),
            this.height = "fixed" === this.widthMode ? n : n / h)),
            "auto" !== this.heightMode && (n = "fixed" === this.heightMode ? d : d * h,
            "auto" === this.widthMode && (a = n * (this.aspectRatio || 1),
            this.width = "fixed" === this.widthMode ? a : a / o)),
    ...
    class Ve extends Ue {
        ...
        unpackageType() {
            return this.fill = be(this.fill),
            this.stroke = be(this.stroke),
            this.render(),
            this
        }
        render() {
            ...
            const a = this.state();
            let {left: n, top: o, width: h, height: l} = this.box();
            const d = Le(this.anchorPoint);
            let u = (null == (e = this.local.stateEffectProps) ? void 0 : e.borderRadius) ?? this.borderRadius
              , c = (null == (t = this.local.stateEffectProps) ? void 0 : t.strokeWidth) ?? this.strokeWidth
              , p = (null == (s = this.local.stateEffectProps) ? void 0 : s.gradientAngle) ?? this.gradientAngle
              , m = (null == (i = this.local.stateEffectProps) ? void 0 : i.rotation) ?? this.rotation
              , g = n - d.x * h
              , f = o - d.y * l;
            if (r.clearRect(0, 0, a.canvasWidth, a.canvasHeight),
            r.beginPath(),
            this.fitToCanvas)
                r.rect(0, 0, a.canvasWidth, a.canvasHeight),
                r.fillStyle = ve(r, {
                    width: a.canvasWidth,
                    height: a.canvasHeight
                }, this.fill, p, this.gradientType);
            else {
                if (r.save(),
                r.translate(g + h / 2, f + l / 2),
                r.rotate(2 * m * Math.PI),
                r.translate(-h / 2, -l / 2),
                "rectangle" === this.type) {
                    let e = u * Math.min(Math.abs(h), Math.abs(l)) / 2;
                    this.drawRoundedRect(r, 0, 0, h, l, e)
                } else
                    "circle" === this.type ? r.ellipse(h / 2, l / 2, Math.abs(h) / 2, Math.abs(l) / 2, 0, 0, 2 * Math.PI) : "polygon" === this.type && this.drawPolygon(r, Math.abs(h / 2), Math.abs(l / 2), this.numSides);
                r.fillStyle = ve(r, this.box(), this.fill, p, this.gradientType)
            }
            r.fill(),
            c && (r.strokeStyle = this.stroke[0],
            r.lineWidth = c,
            r.stroke()),
            r.restore()
        }
        drawRoundedRect(e, t, s, i, r, a) {
            e.beginPath(),
            e.moveTo(t + a, s),
            e.arcTo(t + i, s, t + i, s + r, a),
            e.arcTo(t + i, s + r, t, s + r, a),
            e.arcTo(t, s + r, t, s, a),
            e.arcTo(t, s, t + i, s, a),
            e.closePath()
        }
        drawPolygon(e, t, s, i) {
            e.beginPath();
            for (let r = 0; r < i; r++) {
                const a = 2 * r * Math.PI / i - Math.PI / 2
                  , n = t * Math.cos(a) + t
                  , o = s * Math.sin(a) + s;
                0 === r ? e.moveTo(n, o) : e.lineTo(n, o)
            }
            e.closePath()
        }
    }
    class Be extends ze {
        ...
        unpackage() {
            for (let e in this)
                this[e] && this[e].type && ("Vec2" === this[e].type ? this[e] = new S(this[e]._x,this[e]._y) : "Vec3" === this[e].type && (this[e] = new M(this[e]._x,this[e]._y,this[e]._z)));
            return this
        }
        getParent() {
    ...
    class We extends Ue {
        ...
        renderImage() {
            var e, t;
            if (!(null == (e = this.local) ? void 0 : e.ctx))
                return;
            let s = this.local.ctx;
            const i = this.state();
            s.clearRect(0, 0, i.canvasWidth, i.canvasHeight);
            let {left: r, top: a, width: n, height: o} = this.box()
              , h = i.canvasWidth
              , l = i.canvasHeight;
            if (this.fitToCanvas) {
                let e = this.local.img.width / this.local.img.height;
                h / l < e ? (o = l,
                n = l * e) : (n = h,
                o = h / e);
                const t = (h - n) / 2
                  , i = (l - o) / 2;
                s.drawImage(this.local.img, t, i, n, o)
            } else {
                const e = Le(this.anchorPoint)
                  , i = 2 * ((null == (t = this.local.stateEffectProps) ? void 0 : t.rotation) ?? this.rotation) * Math.PI;
                let h = e.x * n
                  , l = e.y * o;
                s.save();
                let d = n / 2
                ...
                s.translate(c, p),
                s.rotate(i),
                s.drawImage(this.local.img, -d, -u, n, o),
                s.restore()
            }
        }
        render() {}
    ...
    class Ne extends ze {
        constructor(e, t, i) {
            ...
            e.moduleRef && (null == (r = null == i ? void 0 : i.modules) ? void 0 : r[e.moduleRef]) && (this.moduleUrl = i.modules[e.moduleRef].url),
            ...
            this.speed = void 0 !== e.speed ? e.speed : .5,
            ...
            this.colorMapPosition = e.colorMapPosition ? new S(e.colorMapPosition.x ?? .5,e.colorMapPosition.y ?? .5) : new S(.5,.5),
            ...
            this.normalMapPosition = e.normalMapPosition ? new S(e.normalMapPosition.x ?? .5,e.normalMapPosition.y ?? .5) : new S(.5,.5),
        ...
        async loadRenderer() {
            const e = this.state();
            if (!e.curtain || !e.curtain.renderer || !e.curtain.renderer.gl)
                return;
            let t = this.moduleUrl || "https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.5.2/extensions/model-renderer.js";
            try {
        ...
        handleModelLoaded() {
            if (this.local.modelLoaded = !0,
            this.local.renderTarget) {
                let e = this.local.renderTarget.getTexture()
                  , t = this.getPlane().textures.find(e => "uTexture" === e._samplerName);
                t.copy(e),
                t.needUpdate()
            }
        }
        renderModel() {
            var e, t;
            if (!this.local.rendererLoaded || !this.local.modelLoaded)
                return;
            const s = this.state();
            if (!s || s.destroyed || !s.curtain || !s.curtain.renderer || !s.curtain.renderer.gl)
                return;
            const i = s.curtain.renderer.gl;
            if (0 === i.drawingBufferWidth || 0 === i.drawingBufferHeight)
                return;
            if (this.animating) {
            ...
            if (this.environmentMapIntensity > 0) {
                ...
                if (e && !(null == (t = this.environmentMapUrl) ? void 0 : t.trim())) {
                    ...
                    t && t._sampler && t._canDraw && (this.local.envTexture = {
                        gl: i,
            ...
            if (this.renderNormals) {
                ...
                if (e) {
                    const t = e.textures.find(e => "uBgTexture" === e._samplerName);
                    t && t._sampler && t._sampler.texture && (this.local.backgroundTexture = {
                        gl: i,
                        webglTexture: t._sampler.texture,
                        width: t._size.width,
                        height: t._size.height
        ...
        cleanup() {
            ...
            this.local.renderTarget && (this.local.renderTarget.remove(),
    ...
    class He extends Ue {
        ...
        loadFont() {
            ...
            if (Array.from(document.fonts).some(e => e.family === this.fontFamily && e.style === t && s(e.weight) === i && "loaded" === e.status) || !(null == (e = this.fontCSS) ? void 0 : e.src))
        ...
        render() {
            ...
            this.isSafari || (i.textAlign = this.textAlign,
            i.letterSpacing = f + "px");
            ...
            i.fillStyle = ve(i, this.box(), this.fill, this.gradientAngle, this.gradientType);
            const P = (e, t) => {
                let s = c + g * t + g / 2 + m / 3;
                this.isSafari ? ( (e, t, s, i, r, a, n) => {
                    let o, h = t.split("").reduce( (s, i, a) => s + e.measureText(i).width + (a < t.length - 1 ? r : 0), 0);
                    if (o = "center" === a ? s + (n - h) / 2 - n / 2 : s,
                    "right" === a)
                ...
                )(i, e, u, s, f, this.textAlign, n) : i.fillText(e, u, s)
            }
              , w = this.textContent ? this.textContent.split("\n") : [""];
            let T = w.length;
            const R = (e, t, s) => t.split("").reduce( (i, r, a) => (i += e.measureText(r).width,
            a < t.length - 1 && (i += s),
            i), 0);
            for (let S = 0; S < T; S++) {
                let e = ""
                ...
                for (let s = 0; s < t.length; s++) {
                    ...
                    if ((this.isSafari && f ? R(i, a, f) : i.measureText(a).width) > n || "\n" === r) {
                        if ("" !== e)
                            w[S] = e.trim(),
                            s !== t.length - 1 ? (w.splice(S + 1, 0, t.slice(s).join("")),
                            T++) : "\n" !== r && w.push(r);
                        else {
                            let e = r
                              , a = S;
                            for (; e.length > 0; ) {
                                let t = "";
                                for (let s = 0; s < e.length && (i.measureText(t + e[s]).width <= n || 0 == s); s++)
                                    t += e[s];
                                e = e.slice(t.length),
                                w[a] = t.trim(),
                                e.length > 0 && (w.splice(a + 1, 0, e),
                                a++,
                                T++)
                            }
                            t.slice(s + 1).length > 0 && (w[a] += t.slice(s + 1).join(""))
                        }
                        break
                    }
                    e = a,
                    s === t.length - 1 && (w[S] = e.trim())
                }
            }
            w.forEach( (e, t) => {
                P(e, p),
    ...
    function je() {
        let e = performance.now();
        document[ae] ? (cancelAnimationFrame(oe),
        Qe.forEach(t => {
            t.pauseTime = e
        }
        )) : (Ee(),
    ...
    function Ge() {
        ...
        Qe.filter(e => e.initialized).forEach(e => {
            e.refresh()
        }
        ),
        Ye()
    }
    function Xe(e, t, s=50) {
    ...
    function Ye() {
        Qe.filter(e => e.getDynamicLayers().length).forEach(e => {
            let t = e.element.getBoundingClientRect();
            if (e.scrollY = ce,
            e.lastBbox) {
                0 === Math.abs(t.top - e.lastBbox.top) && me > 0 ? (e.fixedCounter = (e.fixedCounter || 0) + 1,
                e.fixedCounter > 3 && (e.isFixed = !0)) : e.fixedCounter = 0
            }
            e.lastBbox = e.bbox,
            e.bbox = t
        }
    ...
    function qe(e) {
        const t = Qe.filter(e => e.getDynamicLayers().length)
          , s = Qe.filter(e => e.rendering);
        t.length && !s.length && Ee();
        const i = performance.now();
        (!ge || i - ge > 64) && Ye(),
        t.forEach(e => {
            if (Xe(e.element, e.bbox, 100)) {
                if (!e.isInView) {
                    e.isInView = !0,
                    e.pauseTime = e.pauseTime - i;
                    const t = e.element.offsetWidth > 0 && e.element.offsetHeight > 0;
                    t && e.curtain ? e.resize() : t || requestAnimationFrame( () => {
                        e.element.offsetWidth > 0 && e.element.offsetHeight > 0 && e.curtain && e.resize()
                    }
                    ),
                    !e.lazyLoad || e.initialized || e.initializing || e.initializePlanes()
                }
            } else
                e.isInView && (e.isInView = !1,
                e.pauseTime = i)
        }
        )
    }
    function $e(e) {
        Qe.filter(e => e.isInView).forEach(e => {
    ...
    function Ze(e) {
        ...
        Qe.filter(e => e.isInView && e.initialized).forEach(s => {
            let i, r, a = s.bbox;
            Math.abs(me) > 1 && t - s.lastBboxTime > 64 && (a = s.element.getBoundingClientRect(),
            s.lastBbox = s.bbox,
            s.bbox = a,
            s.lastBboxTime = t),
            e.targetTouches ? (i = e.targetTouches[0].pageX,
            r = e.targetTouches[0].pageY) : (i = e.pageX,
            r = e.pageY),
            s.isFixed && (s.scrollY = 0,
            r = e.targetTouches ? e.targetTouches[0].clientY : e.clientY);
            const n = i - a.left
              , o = r - (a.top + (s.isFixed ? 0 : ce));
            s.mouse.page.x = i,
            s.mouse.page.y = r,
            s.mouse.movePos.x = .5 * n,
            s.mouse.movePos.y = .5 * o,
    ...
    class Je {
        constructor(e) {
            ...
            this.createCurtains(),
            this.setCanvasScale(),
            this.curtain && (this.textureLoader = new F(this.curtain))
        }
        preloadTextures() {
            this.layers.forEach(e => {
                var t, s, i, r, a, n, o, h, l;
                if (e.isElement)
                    e.local.canvas && this.textureLoader.loadCanvas(e.local.canvas, {
                        sampler: "uTexture",
                        premultiplyAlpha: !0
                    }, t => {
                        t.userData.hasStateEffects = e.states.appear.length > 0 || e.states.scroll.length > 0 || e.states.hover.length > 0,
                        e.preloadedCanvasTexture = t
                    }
                    , e => {}
                    );
                else if ((null == (t = null == e ? void 0 : e.texture) ? void 0 : t.src) || (null == (i = null == (s = null == e ? void 0 : e.data) ? void 0 : s.texture) ? void 0 : i.src)) {
                    const t = (null == (r = null == e ? void 0 : e.texture) ? void 0 : r.src) || (null == (n = null == (a = null == e ? void 0 : e.data) ? void 0 : a.texture) ? void 0 : n.src)
                      , s = (null == (o = null == e ? void 0 : e.texture) ? void 0 : o.sampler) || (null == (l = null == (h = null == e ? void 0 : e.data) ? void 0 : h.texture) ? void 0 : l.sampler) || "uTexture";
                    this.local.preloadedTextures[t] ? this.local.preloadedTextures[t].count++ : (this.local.preloadedTextures[t] = {
                        count: 1,
                        texture: null
                    },
                    this.textureLoader.loadImage(t, {
                        sampler: s,
        ...
        destroy() {
            ...
            this.rendering = !1,
            this.isInView = !1;
            const s = Qe.findIndex(e => e.id === this.id);
            -1 !== s && Qe.splice(s, 1),
            this.layers.filter(e => e.dispose).forEach(e => e.dispose()),
            this.layers = [],
            (null == (e = this.curtain) ? void 0 : e.gl) && (this.curtain.dispose(),
            this.curtain = null),
            this.element && (this.element.removeAttribute("data-us-initialized"),
        ...
        resize() {
            ...
            this.currentBreakpoint = this.breakpoints.find(e => ue >= e.min && ue <= e.max),
            this.curtain && (this.curtain.resize(),
            ...
            this.curtain.planes.forEach(e => {
                e.uniforms.resolution && (e.uniforms.resolution.value.x = this.curtain.canvas.width,
        ...
        refresh() {
            ...
            this.layers.forEach(e => {
                ...
                null == (s = e.states) || s.appear.forEach(t => {
                    e[t.prop] = t.endValue ?? e.local.stateEffectProps[t.prop] ?? e[t.prop]
                }
                ),
                e.breakpoints.length && (e.setBreakpointValues(),
                e.local.bpProps && Object.keys(e.local.bpProps).forEach(t => {
                    e.getPlanes().forEach(s => {
                        s.uniforms[t] && Ae(e.local.bpProps[t], s.uniforms[t], t)
                    }
                    )
                }
                )),
        ...
        getDynamicLayers() {
            return this.layers.filter(e => Re(e))
        }
        createCurtains() {
            this.curtain = new p({
            ...
            this.curtain.gl && (this.curtain.onError(e => {}
            ),
        ...
        renderFrame() {
            var e;
            this.destroyed || (e = this.curtain) && e.renderer && e.renderer.nextRender && "function" == typeof e.renderer.nextRender.execute && (this.layers.forEach(e => {
        ...
        getSplitOrderedItems() {
            ...
            if (s) {
                let i = s.parentLayer ? s.getParent() : null
                  , r = i && Re(i)
                  , a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(e => Re(e)).length;
                for (; s && !Re(s) && !r && !a; )
                    t++,
                    s = e[t],
        ...
        getPlaneParams(e, t) {
            ...
            const h = {
                resolution: {
                    name: "uResolution",
                    type: "2f",
                    value: new S(this.canvasWidth,this.canvasHeight)
                },
                mousePos: {
                    name: "uMousePos",
                    type: "2f",
            ...
            e.usesPingPong && (h.previousMousePos = {
            ...
            if (e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(t => {
                h[t.prop] || t.uniformData && (h[t.prop] = t.uniformData,
                h[t.prop].value = e[t.prop])
            }
            ),
            null == (r = e.data) ? void 0 : r.uniforms)
                for (let u in e.data.uniforms) {
                    ...
                    "Vec3" === (null == (a = t.value) ? void 0 : a.type) ? h[u].value = new M(t.value._x,t.value._y,t.value._z) : "Vec2" === (null == (n = t.value) ? void 0 : n.type) ? h[u].value = new S(t.value._x,t.value._y) : "object" == typeof t.value && (h[u].value = be(t.value))
                }
            return {
                fragmentShader: l,
                vertexShader: d,
        ...
        createPlane(e, t, s) {
            var i;
            let r, a;
            r = e.isElement || e.isModel ? this.getPlaneParams(e) : this.getPlaneParams(e, s ? s.index : null),
            r.watchScroll = !1;
            try {
                if (!this.curtain.container)
                    throw new Error("Can't find scene container");
                let n = (null == s ? void 0 : s.downSample) || 0 === (null == s ? void 0 : s.index) && (null == (i = e.data) ? void 0 : i.downSample)
                  , o = this.renderingScale;
                if (n && (o = "number" == typeof n ? n : .5,
                o *= this.renderingScale),
                e.userDownsample && "number" == typeof e.userDownsample && (o *= e.userDownsample),
                a = new se(this.curtain,this.curtain.container,r),
                !a || !a.userData || !a.textures)
                    throw new Error("Plane not properly initialized");
                return a.textures.length = 0,
                a.userData.id = e.local.id,
                a.userData.layerType = e.layerType,
                a.userData.type = e.type,
                a.userData.downSample = o,
                a.setRenderOrder(t),
                a
            } catch (n) {
                return null
        ...
        createPingPongPlane(e, t, s) {
            var i;
            let r = this.getPlaneParams(e, 1 + ((null == s ? void 0 : s.length) || 0))
              , a = null == (i = this.curtain) ? void 0 : i.planes.find(t => "PingPongPlane" === t.type && t.userData.id === e.local.id);
            if (a)
                a.setRenderOrder(t);
            else {
                if (a = new re(this.curtain,this.curtain.container,r),
                !a)
                    return;
                a.userData.id = e.local.id,
                ...
                a.setRenderOrder(t),
                a.onReady( () => {
                    this.setInitialEffectPlaneUniforms(a, e, null == e ? void 0 : e.getParent(), s),
        ...
        createEffectPlane(e, t, s) {
            ...
            s && (i.userData.passIndex = s.index,
        ...
        createElementPlane(e, t) {
            ...
            s && s.onReady( () => {
                this.setInitialElementPlaneUniforms(s, e),
        ...
        handleMediaTextures(e, t, s) {
            var i;
            if ([t.texture, null == (i = t.data) ? void 0 : i.texture].filter(e => null == e ? void 0 : e.src).forEach(i => {
                var r;
                if (null == (r = t.compiledFragmentShaders[s.passIndex ?? 0]) ? void 0 : r.includes(i.sampler)) {
                    const t = this.local.preloadedTextures[i.src];
                    (null == t ? void 0 : t.texture) ? (t.count > 1 ? (Fe(e, i.sampler, t.texture),
                    t.count--) : e.addTexture(t.texture),
                    e.userData.textureLoaded = !0) : this.textureLoader.loadImage(i.src, {
                        premultipliedAlpha: !1,
                        sampler: i.sampler
                    }, t => {
                        e.addTexture(t),
            ...
            "video" === t.type) {
                const s = t.src.includes(", ") ? function(e) {
        ...
        handleEffectPlane(e, t, s) {
            ...
            if (n && (null == o ? void 0 : o.includes("uPingPongTexture")) && Fe(r, "uPingPongTexture", n.getTexture()),
            a ? Fe(r, "uTexture", a.getTexture()) : Fe(r, "uTexture"),
            null == o ? void 0 : o.includes("uBgTexture")) {
                let e = this.getRenderTargets()[t - (1 + s.passIndex)];
                e && Fe(r, "uBgTexture", e.getTexture())
            }
        ...
        handleModelPlane(e, t) {
            ...
            i.textures = [],
            (null == (s = e.local.renderTarget) ? void 0 : s.getTexture) && e.local.modelLoaded ? i.addTexture(e.local.renderTarget.getTexture()) : i.createTexture({
                sampler: "uTexture",
                premultipliedAlpha: !0,
                fromTexture: r.getTexture()
            }),
            r && e.renderNormals && i.createTexture({
                sampler: "uRefractTexture",
                premultipliedAlpha: !0,
                fromTexture: r.getTexture()
            }),
            n.local.lastTarget && i.createTexture({
                sampler: "uBgTexture",
                premultipliedAlpha: !0,
                fromTexture: n.local.lastTarget.getTexture()
            })
        }
        handleElementPlane(e, t) {
            ...
            let a, n = this.getRenderTargets()[t - 1], o = r[r.indexOf(e) - 2];
            if (e.mask && o && (a = o.local.lastTarget),
            i.length || (s.textures.length = 0),
            n && i.length ? Fe(s, "uTexture", n.getTexture()) : s && s.addTexture(e.preloadedCanvasTexture),
            n) {
                if (i.length) {
                    let e = i.reduce( (e, t) => e + t.getPlanes().length, 0);
                    n = this.getRenderTargets()[t - (1 + e)]
                }
                n && (Fe(s, "uBgTexture", n.getTexture()),
                a && e.mask && Fe(s, "uPreviousLayerTexture", a.getTexture()))
            }
        }
        handleChildEffectPlane(e, t, s) {
            ...
            let n = this.getRenderTargets()[t - 1]
              , o = null == (i = this.curtain) ? void 0 : i.planes.find(t => "PingPongPlane" === t.type && t.userData.id === e.local.id)
              , h = e.compiledFragmentShaders[s.passIndex ?? 0]
              , l = a.effects.filter(e => {
            ...
            if (n && (d || s.passIndex > 0) ? (e.isMask && (!s.length || u && c) && r.addTexture(a.preloadedCanvasTexture),
            Fe(r, "uTexture", n.getTexture())) : e.isMask ? (u && c && r.addTexture(a.preloadedCanvasTexture),
            n ? Fe(r, "uTexture", n.getTexture()) : Fe(r, "uTexture")) : (null == h ? void 0 : h.includes("uTexture")) && (r.addTexture(a.preloadedCanvasTexture),
            a.preloadedCanvasTexture.userData.used = !0),
            o && (null == h ? void 0 : h.includes("uPingPongTexture")) && Fe(r, "uPingPongTexture", o.getTexture()),
            null == h ? void 0 : h.includes("uBgTexture"))
                if (d && s.length > 1) {
                    let e = this.getRenderTargets()[t - (1 + s.length)];
                    e && Fe(r, "uBgTexture", e.getTexture())
                } else
                    a.preloadedCanvasTexture.userData.used ? r.loadCanvas(a.local.canvas, {
                        sampler: "uBgTexture",
                        premultiplyAlpha: !0
                    }, e => {
                        e.shouldUpdate = a.preloadedCanvasTexture.shouldUpdate
                    }
                    ) : (a.preloadedCanvasTexture._samplerName = "uBgTexture",
                    r.addTexture(a.preloadedCanvasTexture));
            "custom" === e.type && Fe(r, "uCustomTexture", this.getRenderTargets()[t]),
            this.handleMediaTextures(r, e, s)
        }
        createPlanes() {
            this.getOrderedItems().forEach( (e, t) => {
                e.getPlanes().length ? e.getPlanes().forEach(e => e.setRenderOrder(t)) : e.isElement ? this.createElementPlane(e, t) : e.isModel ? this.createModelPlane(e, t) : this.createEffectPlanes(e, t)
            }
            )
        }
        createModelPlane(e, t) {
            const s = this.createPlane(e, t);
            s && s.onReady( () => {
                s.userData.isReady = !0,
                s.userData.createdAt = performance.now();
                let t = e.userDownsample || 1
                  , i = this.curtain.canvas.width * t
                  , r = this.curtain.canvas.height * t;
                e.local.renderTarget || (e.local.renderTarget = new ie(this.curtain,{
                    depth: !0,
                    maxWidth: i,
                    maxHeight: r,
                    texturesOptions: {
                ...
                this.setModelPlaneUniforms(s, e),
        ...
        createEffectPlanes(e, t) {
            ...
            e.usesPingPong && this.createPingPongPlane(e, t, s.passes)) : (this.createEffectPlane(e, t),
            e.usesPingPong && this.createPingPongPlane(e, t))
        }
        createTextures() {
        ...
        handleTextures(e, t, s) {
            e.isElement ? this.handleElementPlane(e, t) : e.isModel ? this.handleModelPlane(e, t) : e.parentLayer ? this.handleChildEffectPlane(e, t, s) : this.handleEffectPlane(e, t, s)
        }
        handleItemPlanes(e) {
            this.createPlanes(),
            this.createTextures(),
        ...
        setModelPlaneUniforms(e, t) {
            ...
            e.uniforms.resolution.value.y = this.curtain.canvas.height;
            const s = this.calculateItemMouseValues(t);
            s && !t.local.mouse && (t.local.mouse = {
                x: .5,
                y: .5
            }),
            s && (t.local.mouse.x = s.x,
            t.local.mouse.y = s.y),
            e.uniforms.opacity && (e.uniforms.opacity.value = t.local.modelLoaded ? t.opacity : 0)
        }
        setInitialEffectPlaneUniforms(e, t, s, i) {
            var r;
            if (!e.userData.initialUniformsSet || !e.userData.isReady) {
                for (let s in e.uniforms)
                    (null == (r = t.states) ? void 0 : r.scroll.some(e => e.prop === s)) || (t.local.bpProps && s in t.local.bpProps ? Ae(t.local.bpProps[s], e.uniforms[s], s) : s in t && Ae(t[s], e.uniforms[s], s));
        ...
        setInitialElementPlaneUniforms(e, t) {
            ...
            for (let i in e.uniforms)
                t.local.bpProps && i in t.local.bpProps ? e.uniforms[i].value = t.local.bpProps[i] : i in t && (e.uniforms[i].value = (null == (s = t.local.stateEffectProps) ? void 0 : s[i]) ?? t[i]);
        ...
        setElementPlaneUniforms(e, t) {
            if (e.uniforms.mousePos) {
                ...
                if (!s)
                    return;
                !this.mouse.movedInView || e.uniforms.mousePos.value.x === s.x && e.uniforms.mousePos.value.y === s.y || (e.uniforms.mousePos.value.x = s.x,
                e.uniforms.mousePos.value.y = s.y)
            }
        }
        calculateItemMouseValues(e) {
            if (!this.mouse.movedInView)
                return null;
            const t = this.bbox.width / 2
              , s = this.bbox.height / 2
              , i = this.getMousePosWithMomentum(e, t, s);
            return this.local.mouseValuePool || (this.local.mouseValuePool = new S(.5)),
        ...
        getMousePosWithMomentum(e, t, s) {
            ...
            const u = e.local.lastMousePos.x * t
              ...
              , p = Math.abs(i - u)
              , m = Math.abs(r - c);
            return p < fe && m < fe || (n ? (i = Pe(i, u, 2 * h),
            e.local.lastMousePos.x = i / t) : e.local.lastMousePos.x = .5,
            o ? (r = Pe(r, c, 2 * h),
            e.local.lastMousePos.y = 1 - r / s) : e.local.lastMousePos.y = .5),
            e.local.lastMousePos
        }
        setEffectPlaneUniforms(e, t) {
            var s, i, r, a;
            let n = (null == (s = t.local.stateEffectProps) ? void 0 : s.speed) ?? t.speed ?? 1;
            if (t.animating && e.uniforms.time && (e.uniforms.time.value += 60 * n / this.fps),
            (null == (i = t.local.stateEffectProps) ? void 0 : i.playbackRate) && e.videos.at(-1) && (e.videos.at(-1).playbackRate = t.local.stateEffectProps.playbackRate),
            we() && (null == (a = null == (r = this.interactivity) ? void 0 : r.mouse) ? void 0 : a.disableMobile))
                return !1;
            if (!this.mouse.movedInView)
                return;
            t.local.currentFrameMouseValues || (t.local.currentFrameMouseValues = this.calculateItemMouseValues(t));
            const o = t.local.currentFrameMouseValues;
            o && (e.uniforms.previousMousePos && (this.mouse.ticks > 16 ? (e.uniforms.previousMousePos.value.x = e.uniforms.mousePos.value.x,
            e.uniforms.previousMousePos.value.y = e.uniforms.mousePos.value.y) : (e.uniforms.previousMousePos.value.x = o.x,
            e.uniforms.previousMousePos.value.y = o.y)),
            e.uniforms.mousePos && !o.equals(e.uniforms.mousePos.value) && (e.uniforms.mousePos.value.x = o.x,
        ...
        getTextureParams(e, t, s) {
            ...
            const r = e[t];
            let a = 1;
            r.userData.downSample && (a = "number" == typeof r.userData.downSample ? r.userData.downSample : .5);
            return {
        ...
        waitForAssetsAndDisablePlanes() {
            this.layers.some(e => e.isModel && !e.local.modelLoaded || "image" === e.layerType || "text" === e.layerType && !e.local.loaded || Object.values(this.local.preloadedTextures).some(e => e && null === e.texture)) ? setTimeout( () => this.waitForAssetsAndDisablePlanes(), 64) : (this.layers.filter(e => e.preloadedCanvasTexture).forEach(e => {
    ...
    function tt() {
        Ke(window, "scroll", qe),
        we() ? Ke(window, "touchmove", Ze) : Ke(window, "mousemove", Ze),
        Ke(window, "routeChange", Me),
        Ke(document, "mouseleave", $e),
        he = function(e, t) {
            let s;
            return function(...i) {
                clearTimeout(s),
        ...
        we() ? Ke(window, "orientationchange", he) : Ke(window, "resize", he),
        Ke(document, ne, je),
        le = !0
    }
    function st() {
        et(window, "mousemove", Ze),
        et(window, "touchmove", Ze),
        et(window, "scroll", qe),
        et(window, "routeChange", Me),
        et(document, "mouseleave", $e),
        he && (et(window, "resize", he),
        et(window, "orientationchange", he)),
        et(document, ne, je),
        le = !1
    }
    function it(e) {
            ...
            (function(e, t, s, i, r) {
                ...
                if (s) {
                    ...
                    if (e)
                        try {
                            ...
                            return (null == t ? void 0 : t.options) && ((null == t ? void 0 : t.layers) || (null == t ? void 0 : t.history)) ? Promise.resolve(t) : (i(new Error(`Did not find valid JSON inside ${s}`)),
                            Promise.reject())
                        } catch (n) {
                            return i(new Error(`Error parsing JSON from ${s}: ${n.message}`)),
                            Promise.reject()
                        }
                } else {
                    let s = "https://storage.googleapis.com/unicornstudio-production";
                    r || (null == t ? void 0 : t.includes("production=true")) ? (s = "https://assets.unicorn.studio",
                    t = `v=${Date.now()}`) : (null == t ? void 0 : t.includes("update=")) || (t = `v=${Date.now()}`),
                    a = `${s}/embeds/${e}${t ? "?" + t : ""}`
                }
                return fetch(a).then(e => e.json()).then(e => e).catch(e => {}
                )
            }
            )(t, s, e.filePath, r, e.production).then(s => {
                s && (s.layers || s.history) && s.options || r(new Error(`Error fetching data for project id '${e.projectId}'`));
                const a = s.options || {}
                  , n = (o = e.element,
                ("object" == typeof HTMLElement ? o instanceof HTMLElement : o && "object" == typeof o && null !== o && 1 === o.nodeType && "string" == typeof o.nodeName) ? e.element : document.getElementById(e.elementId));
                var o;
                if (!n)
                    return void r(new Error(`Couldn't find an element with id '${e.elementId}' on the page.`));
                const h = xe();
                ...
                const u = function(e, t, s, i) {
                    ...
                    return e.forEach(e => {
                        switch (e.layerType) {
                        case "text":
                            a.push(new He(e,t,null,r).unpackage());
                            break;
                        case "image":
                            a.push(new We(e,t,r).unpackage());
                            break;
                        case "model":
                            a.push(new Ne(e,t,r).unpackage());
                            break;
                        case "shape":
                            a.push(new Ve(e,t,r).unpackage());
                            break;
                        case "effect":
                            a.push(new Be(e,t,r).unpackage())
                        }
                    }
                    ),
                    a
                }(s.layers || s.history, h, function(e, t, s) {
                    return {
                ...
                let p = a[_e("ZnJlZVBsYW4=")];
                (p || a[_e("aW5jbHVkZUxvZ28=")]) && function(e, t) {
                    const s = document.createElement("a");
                    s.href = "https://unicorn.studio?utm_source=public-url",
                    s.style = "position: absolute; display: flex; bottom: 30px; left: 0; width: 190px; margin: 0 auto; right: 0rem; padding: 10px; border-radius: 6px; background-color: rgba(255, 255, 255, 1); box-shadow: 0 3px 9px 0 rgba(0, 0, 0, .2); z-index: 99999999; box-sizing: border-box;",
                    s.target = "_blank";
                    const i = document.createElement("img");
                    i.src = _e("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn"),
                    i.alt = _e("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv"),
                ...
                c.isInView = c.isFixed || Xe(c.element, c.bbox, 50),
    ...
    e.init = function() {
        return function() {
            ...
            s.filter(e => !e.getAttribute("data-us-initialized")).forEach( (t, r) => {
                ...
                i( () => {
                    const i = Te(t, "data-us-project")
                      , a = Te(t, "data-us-project-src")
                      , n = Te(t, "data-us-disablemobile")
                      , o = Te(t, "data-us-disablemouse");
                    it({
                        projectId: a ? null : i,
                        filePath: a,
                        element: t,
                        dpi: +Te(t, "data-us-dpi"),
                        scale: +Te(t, "data-us-scale"),
                        production: Te(t, "data-us-production"),
                        fps: +Te(t, "data-us-fps"),
                        lazyLoad: Te(t, "data-us-lazyload"),
                        altText: Te(t, "data-us-alttext"),
                        ariaLabel: Te(t, "data-us-arialabel"),
                        fixed: Te(t, "data-us-fixed"),
                        interactivity: n || o ? {
                            mouse: {
                                disableMobile: n,
                                disabled: o
